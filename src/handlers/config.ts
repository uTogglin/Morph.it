...
class configHandler implements FormatHandler {
  ...
  async doConvert(
    ...
    const {
      parseJSON, parseJSON5, parseJSONC, parseYAML, parseTOML, parseINI,
      stringifyJSON, stringifyJSON5, stringifyJSONC, stringifyYAML, stringifyTOML, stringifyINI,
    } = await import("confbox");
