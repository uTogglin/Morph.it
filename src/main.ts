...
const toolLabels: Record<string, string> = {
  ...
  speech: "Text & Speech", summarize: "Summarize",
...
function openSettings(panel?: string) {
  ...
  if (activeTool) {
    ...
    const toolPanel = activeTool === "compress" ? "compress" : activeTool === "image" ? "image" : activeTool === "speech" ? "speech" : activeTool === "summarize" ? "summarize" : activeTool === "ocr" ? "ocr" : activeTool === "pdf-editor" ? "pdf-editor" : "convert";
...
window.addEventListener("drop", (e) => {
  ...
  if (activeTool === "compress" || activeTool === "image" || activeTool === "speech" || activeTool === "summarize" || activeTool === "ocr" || activeTool === "pdf-editor") return;
  fileSelectHandler(e);
});
